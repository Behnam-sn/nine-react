...
export const HeadBar = () => {
  ...
  return (
    <header className="fixed top-0 z-20 flex w-full items-center justify-between bg-primary-900 p-3 transition-colors duration-300 dark:bg-secondary-900 lg:hidden">
