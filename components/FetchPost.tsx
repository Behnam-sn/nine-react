  ...
  return (
    <>
      ...
      <div className="flex text-secondary-900 transition-colors duration-300 dark:text-primary-900">
        <button
          className={`my-2 ml-2 mr-1 flex w-full justify-center rounded-md py-2 font-semibold ${
        ...
        <button
          className={`my-2 ml-1 mr-2 flex w-full justify-center rounded-md py-2 font-semibold ${
