...
export const CustomTextarea = (props: any) => {
  ...
  return (
    <>
      <textarea
        className={`my-5 h-60 w-full rounded-lg bg-primary-200 py-3 px-3 text-primary-900 outline-none ring-2 transition-colors duration-300 dark:bg-primary-700 dark:text-primary-100 ${
